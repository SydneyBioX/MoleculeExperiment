...
srList <- lapply(boundaries(me, boundaries_assay)[[boundaries_assay]],
                function(bds) {sp::SpatialPolygons(mapply(
...
readsList <- lapply(SpatialUtils::molecules(me, molecules_assay)[[molecules_assay]],
                    function(reads) {
