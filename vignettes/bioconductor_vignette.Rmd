...
# Minimal example
Show here code to 1) make an ME, 2) visualise an ME (using ggplot and the
flatten option of getters), and 3) transforming data to a SPE.
REMEMBER TO USE LITTLE ARGUMENTS AS POSSIBLE: use defaults here: simple code
The detailed arguments can be used later in the vignette. 
...
If the boundary information is for nuclei, the structure would be: "nucleus" >
